...
export default function Hero() {
  return (
    <section className="bg-linear-to-r from-blue-600 to-blue-800 rounded-lg shadow-lg mt-8">
      <div className="text-white text-center py-16 px-8 my-8">
        ...
        <Link
          ...
          className="inline-block border-2 border-white text-white px-8 py-3 rounded-md text-lg font-medium hover:bg-white hover:text-blue-700 hover:scale-105 transition-all duration-300"
        >
          View My Resume
        </Link>
      </div>
